...
class _HomepageState extends State<Homepage> {
  ...
  // Future<void> removeUserToRoom({required String roomId,required String uid}) {
  //   DocumentReference userAdd = FirebaseFirestore.instance.collection('Rooms').doc(roomId);
  //   return userAdd.update({
                                                      ...
                                                      child: GestureDetector(
                                                        onTap: (){
                                                          switch(i){
                                                            ...
                                                            case 1:{
                                                              if(joinCode.text != ""){
                                                                addUserToRoom(roomId:joinCode.text.toString(),uid: "jhgifktu4kjhkj5kjjk");
                                                              }
                                                            }
                                                            break;
                                                            default:
                     ...
                     child: Text("Your Rooms",style: GoogleFonts.openSans(
                      ...
                      ListView.builder(
                        ...
                        return users.contains(userData?["uid"])
                          ...
                          child: GestureDetector(
                            onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>Room(room: roomList[i])));
                            },
                            child: Container(
                              height: 0.35.sw,
                              width: 0.7.sw,
